...
public class AdminHoaDonController : AdminBaseController
{
    private readonly DBBanDienThoaiContext _context;

    public AdminHoaDonController(DBBanDienThoaiContext context)
    {
        _context = context;
    }
    ...
    public IActionResult Index(int? trangThai, int page = 1)
    {
       ...
       .ToList();
        ...
        return View("~/Views/Admin/AdminHoaDon/Index.cshtml", hoaDons);
    }
    ...
    public IActionResult Edit(string id)
    {
        ...
        return View("~/Views/Admin/AdminHoaDon/Edit.cshtml", hoaDon);
    }
